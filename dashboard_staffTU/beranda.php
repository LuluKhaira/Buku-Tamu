...
<body class="d-flex" style="background:#f2f2f2;">
      ...
      <div class="row">
        ...
        <div class="col-xl-4 col-md-6 mb-4">
          <div class="card h-100 py-2"
            style="border-left:8px solid #f4b942; box-shadow:0 4px 10px rgba(0,0,0,0.15);">
            <div class="card-body">
        ...
        <div class="col-xl-4 col-md-6 mb-4">
          <div class="card h-100 py-2"
            style="border-left:8px solid #2d5f5d; box-shadow:0 4px 10px rgba(0,0,0,0.15);">
            <div class="card-body">
              <div class="row align-items-center">
                <div class="col">
  ...
  <script>
    function updateClock() {
      ...
      document.getElementById("clockTime").textContent = `${jam}:${menit}`;
