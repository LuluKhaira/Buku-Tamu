        ...
        <div class="row gy-4 gx-4">
            <div class="col-lg-6">
                <div class="no-bg-panel">
                    ...
                    <h2 class="fw-bold mb-4"> Silahkan isi Informasi <span style="color: #f4b942; font-style: italic;">Pengunjung!</span>
                    </h2>
                    ...
                    <form id="formTamu">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="id" name="no_hp" class="form-control" placeholder="08xxxxxxxxxx" required>
                            </div>
                        </div>

                        <div class="mb-3">
                            <label class="form-label small fw-semibold">Instansi *</label>
                            <input type="text" name="instansi" class="form-control" placeholder="Instansi / Sekolah / Perusahaan" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label small fw-semibold">Tujuan *</label>
                            <textarea name="tujuan" class="form-control" rows="4" placeholder="Masukkan tujuan kedatangan..." required></textarea>
                        </div>
