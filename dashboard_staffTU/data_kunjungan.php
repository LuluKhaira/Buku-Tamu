...
<body style="background:#f2f2f2;">
            ...
            <form method="GET" class="rounded-4 p-3 row g-2 align-items-center">
              <div class="col">
                <div class="input-group">
                  ...
                  <input type="text" name="search" value="<?= htmlspecialchars($_GET['search'] ?? '') ?>" class="form-control" placeholder="Cari nama, instansi, tujuan...">
                </div>
              </div>
              <div class="col-auto">
  ...
  <script src="../dashboard_staffTU/edit_hapus.js"></script>
